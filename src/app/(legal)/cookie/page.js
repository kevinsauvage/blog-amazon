...
function page() {
  return (
    <div className={styles.content}>
      <PageBannerWrapper
        title="Cookie policy"
        subtitle='[Your Blog Name] ("we" or "us") uses cookies on our website. By using
      ...
      <Container>
        ...
        <ul>
          ...
          <li>
            ...
            advertisements based on your interests and browsing behavior. We may use Google AdSense
            or other advertising partners to display these ads.
          </li>
        </ul>
        ...
        <p>
          We reserve the right to update or modify this Cookie Policy at any time. Any changes will
